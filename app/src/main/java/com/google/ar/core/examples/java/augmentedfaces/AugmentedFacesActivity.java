...
public class AugmentedFacesActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
  ...
  public void onSurfaceCreated(GL10 gl, EGLConfig config) {
    ...
    try {
      ...
      noseObject.createOnGlThread(/*context=*/ this, "models/nose.obj", "models/cat5.png");
      noseObject.setMaterialProperties(0.0f, 1.0f, 0.1f, 6.0f);
      noseObject.setBlendMode(ObjectRenderer.BlendMode.AlphaBlending);
      rightEarObject.createOnGlThread(this, "models/forehead_right.obj", "models/earfur.png");
      ...
      leftEarObject.createOnGlThread(this, "models/forehead_left.obj", "models/earfur.png");
